...
const InicioUsuario = () => {
    ...
    return (
        <>
            ...
            {
                cargando === true ? (
                    <div className="flex justify-center fs-10 p-20 black-color">
                    ...
                    usuario !== null && usuario !== undefined ? (
                        <>
                            <div className="flex justify-between items-center px-4 pt-6">
                                <h2 className="secondary-color m-0">Bienvenido, {usuario.nombres.split(" ")[0] + " " + usuario.apellidos.split(" ")[0]}</h2>
                                <Link className="perfil__miniatura" to="/perfil">
                                    <img src={`${process.env.REACT_APP_URL_API}/uploads/usuarios/${usuario.url_foto}`} alt="Imagen perfil" title="Ver Perfil"/>
                                </Link>
                            </div>
